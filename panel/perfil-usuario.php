                            ...
                            <div class="p-5">
                                ...
                                <form action="controlador/editarUsuario.php" method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3"> 
                                            <input type="number" class="form-control" value="<?php echo $row['pontos']; ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="nomes" value="<?php echo $row['nomes']; ?>" >
                                        </div>
                                        <div class="col-sm-6"> 
                                            <input type="text" class="form-control" name="apelidos" value="<?php echo $row['apelidos']; ?>" >
                                        </div>
                                    </div>
                                    <br>    
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" name="direcao" value="<?php echo $row['direcao']; ?>" >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-6">
                                    ...
                                    <br>
                                    <button type="submit" name="guardar" class="btn btn-warning btn-user btn-block">Atualizar</button>
                                    <hr>
                                </form>
                            </div>
                        </div>
