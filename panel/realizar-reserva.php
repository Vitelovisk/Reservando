                            ...
                            <div class="p-5">
                                ...
                                <form action="controlador/guardarReserva.php" method="POST">
                                    <div class="form-group row">
                                        ...
                                        if($quantidade > 0){?>
                                            <label style="color: green;">Mesa: Disponivel</label>
                                        <?php } else  { ?>
                                            <label style="color: red;">Mesa: Não Disponivel</label>
                                            <?php }?>
                                        </div>
                                        <div class="col-sm-8">
                                            <label>N° Pessoas x Mesa: 4 Pessoas - 1 Mesa</label>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                            <input type="number" class="form-control" id="quantidade" name="quantidade" placeholder="N° Pessoas">
                                        </div>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <textarea name="comentario"  class="form-control" placeholder="Comentario / Recomendação" rows="3"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-6">
